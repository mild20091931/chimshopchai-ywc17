  ...
  render() {
    ...
    return (
      <Fragment>
        ...
        <Store
          subTitle="ค้นหารายชื่อร้านค้า"
          pathImg="img/banner_store.png"
          msgButton="รายชื่อร้านค้าที่เข้าร่วมโครงการ"
        />
        <Step
          subTitle="ขั้นตอนการเข้าใช้งานผ่าน<br>แอปฯ “เป๋าตัง”"
          video="https://www.youtube.com/embed/ZkniwQLv_Xk"
          msgButton="ขั้นตอนทั้งหมด"
        />
        <Store
          subTitle="เติมเงินเข้า “เป๋าตัง”<br/> (G-Wallet)"
          pathImg="img/banner_touup-GW.png"
          msgButton="ดูขั้นตอนทั้งหมด"
        />
        <Step
